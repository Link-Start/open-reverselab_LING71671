...
- [`24-database/00-overview.md`](24-database/00-overview.md) — 数据库攻击全景与决策树
- [`24-database/01-sqli-fundamentals.md`](24-database/01-sqli-fundamentals.md) — SQL 注入基础：类型、探测、利用
- [`24-database/02-sqli-advanced.md`](24-database/02-sqli-advanced.md) — 高级 SQLi：WAF 绕过、二阶注入、OOB
- [`24-database/03-nosql-injection.md`](24-database/03-nosql-injection.md) — NoSQL 注入：MongoDB/Redis/ES/CouchDB/Memcached
- [`24-database/04-config-exposure.md`](24-database/04-config-exposure.md) — 数据库配置泄露：\.env/config\.php/默认凭证
- [`24-database/05-backup-log-leak.md`](24-database/05-backup-log-leak.md) — 备份/日志/安装残留文件暴露
- [`24-database/06-card-platform.md`](24-database/06-card-platform.md) — 数字商品交付安全（抽象模式）
- [`24-database/07-data-cleaning.md`](24-database/07-data-cleaning.md) — 泄露数据清洗方法论
- [`24-database/README.md`](24-database/README.md) — 数据库攻击技术索引

### 25-rce-shell — 代码执行与 Shell（7）

- [`25-rce-shell/00-overview.md`](25-rce-shell/00-overview.md) — RCE 攻击全景与决策树
- [`25-rce-shell/01-command-injection.md`](25-rce-shell/01-command-injection.md) — OS 命令注入：操作符、盲打、绕过、参数注入
- [`25-rce-shell/02-webshell.md`](25-rce-shell/02-webshell.md) — Webshell：形态、免杀、WAF 绕过、无文件
- [`25-rce-shell/03-php-disable-functions-bypass.md`](25-rce-shell/03-php-disable-functions-bypass.md) — PHP 函数禁用绕过：LD_PRELOAD/FFI/UAF/imap_open
- [`25-rce-shell/04-reverse-shell-bind.md`](25-rce-shell/04-reverse-shell-bind.md) — 反弹/绑定 Shell 与隧道突破
- [`25-rce-shell/05-chain-playbook.md`](25-rce-shell/05-chain-playbook.md) — 漏洞→Shell 串接方法论（8 条链）
- [`25-rce-shell/README.md`](25-rce-shell/README.md) — 代码执行与 Shell 获取索引

### 26-privilege-escalation — 权限提升（7）

- [`26-privilege-escalation/00-overview.md`](26-privilege-escalation/00-overview.md) — PE 全景与决策树
- [`26-privilege-escalation/01-linux-sudo-suid.md`](26-privilege-escalation/01-linux-sudo-suid.md) — SUDO 滥用 + SUID/SGID + Capabilities + PATH
- [`26-privilege-escalation/02-linux-cron-service.md`](26-privilege-escalation/02-linux-cron-service.md) — Cron/服务/通配符注入/NFS/库劫持
- [`26-privilege-escalation/03-linux-kernel-cve.md`](26-privilege-escalation/03-linux-kernel-cve.md) — Linux 内核 CVE 利用方法论（含 2025-2026 DirtyFrag/CopyFail/nftables UAF）
- [`26-privilege-escalation/04-windows-pe.md`](26-privilege-escalation/04-windows-pe.md) — Windows 提权方法论（Potato/UAC/CVE-2025-60718）
- [`26-privilege-escalation/05-container-escape.md`](26-privilege-escalation/05-container-escape.md) — 容器逃逸（含 runC CVE-2025/DirtyFrag K8s）
- [`26-privilege-escalation/README.md`](26-privilege-escalation/README.md) — 权限提升技术索引
